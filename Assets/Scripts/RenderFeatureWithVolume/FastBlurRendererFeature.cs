...
public sealed class FastBlurRendererFeature : ScriptableRendererFeature
{
    ...
    private class FastBlurRenderPass : ScriptableRenderPass
    {
        #region PASS_FIELDS
        ...
        private const int PassMask = 1;
        private const int PassBlurVertical = 2;
        private const int PassBlurHorizontal = 3;
        private const int PassCompositeScreen = 4;
        private const int PassCompositeAdd = 5;
        private const int PassCompositeBlur = 8;
        ...
        private static readonly int MaskIntensityId = Shader.PropertyToID("_MaskIntensity");
        private static readonly int ContrastId = Shader.PropertyToID("_Contrast");
        private static readonly int LerpInStartEndId = Shader.PropertyToID("_LerpInStartEnd");
        private static readonly int LerpOutStartEndId = Shader.PropertyToID("_LerpOutStartEnd");

        #endregion                    
        
        public FastBlurRenderPass(Shader shader)
        {
            m_Material = CoreUtils.CreateEngineMaterial(shader);
            // _renderTextureDescriptor = new RenderTextureDescriptor(Screen.width, Screen.height, RenderTextureFormat.Default, 0);
        }
        public FastBlurRenderPass(string passName, Material material)
        {
