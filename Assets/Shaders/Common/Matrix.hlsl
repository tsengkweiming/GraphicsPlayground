...
{
    return 1.0 / determinant(m) *
        float3x3( m._22 * m._33 - m._23 * m._32,  -(m._12 * m._33 - m._13 * m._32),  m._12 * m._23 - m._13 * m._22,
...
float3x3 Homography(float2 p00, float2 p01, float2 p10, float2 p11)
{
    float x00 = p00.x;
    float y00 = p00.y;
    float x01 = p01.x;
